  ...
  <Layout className="layout">
    ...
    <Content style={{ padding: '0 50px' }}>
      <Breadcrumb style={{ margin: '16px 0' }}>
        ...
        <Breadcrumb.Item>Weather Report</Breadcrumb.Item>
      </Breadcrumb>
      <div style={{ background: '#fff', padding: 24, minHeight: 280 }}><div className="headerdata">
    ...
    <Footer style={{ textAlign: 'center' }}>
      Ant Design ©2018 Created by Touhid
    </Footer>
  </Layout>,
